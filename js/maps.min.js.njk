...
{% set js %}
  function map_init() {
      ...
      var tiles = L.tileLayer('https://tile.thunderforest.com/landscape/{z}/{x}/{y}.png?apikey=6288f178f51b4f71902c8ec852b45be3', {
          maxZoom: 19,
  ...
  function map_home() {
      ...
      {%- for trailhead in hiketrailheads %}
          L.marker([{{ trailhead.latitude }}, {{ trailhead.longitude }}], { title: '{{ trailhead.name }}' })
              .addTo(map)
